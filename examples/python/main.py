"""
Example: How to call the jobindex-dk-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/jobindex-dk-scraper
...
def run_actor():
    """Run the jobindex-dk-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/jobindex-dk-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://www.jobindex.dk/jobsoegning/undervisning/paedagog/nordsjaelland"}],
            "maxItems": 10,
